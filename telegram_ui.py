...
TEST_PURCHASED_POPUP = "✅ تست با موفقیت خریداری شد!"
TEST_STARTED_POPUP = "🚀 تست شروع شد!"
...
PROCESSING_MESSAGES = [
    ...
    "📝 دارم گزارش نهایی رو آماده می‌کنم..."
]
...
PACKAGE_TEST_SELECTION = "📋 لطفاً یکی از تست‌های زیر را انتخاب کنید:"
